        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCoffeMachine = table.Column<bool>(type: "bit", nullable: false),
                    RoomID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SummaryPdf = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MeetingID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10589dcb-b694-4041-909d-6b099c469fec", null, "Employee", "EMPLOYEE" },
                    { "922d7c71-dd77-47d6-b364-9d4b3e69c465", null, "User", "USER" },
                    { "be001491-5af8-43a0-b0b3-231533436d08", null, "Admin", "ADMIN" }
                });
